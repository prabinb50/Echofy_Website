  ...
  return (
    ...
    >
      ...
      <img
        ...
        className="absolute top-10 left-10 w-30 animate-[floatShape_4s_ease-in-out_infinite] opacity-70 brightness-150"
      />
      <img
        src="/footer-line.png"
        alt="decorative line"
      ...
      <div className="relative mx-auto max-w-6xl top-20">
        ...
        >
          ...
          {/* floating leaf icon (hidden on small screens) */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={i}
                  className="text-gray-300 hover:text-lime-400 transition-colors cursor-pointer text-sm flex items-center gap-2"
                >
                  <span className="text-lime-400">›</span>
                  {item}
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full p-4 rounded-full text-gray-800 text-sm placeholder-gray-500 border-none outline-none"
              />
              <button className="relative group inline-flex items-center gap-2 py-3 px-10 rounded-full cursor-pointer text-white overflow-hidden bg-lime-500 border border-lime-500">
